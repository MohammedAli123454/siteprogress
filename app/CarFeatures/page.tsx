...
export default function CarFeatures() {
    ...
    return (
      <div className="p-4">
        ...
        <Button onClick={() => setIsDrawerOpen(true)} className="mb-4 bg-blue-500 text-white">
          Add Features
        </Button>
        ...
        <Drawer open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
          ...
          <h2 className="text-xl font-bold mb-4 text text-center">Select Car Features</h2>
          ...
          <div className="mt-6 flex justify-end gap-4">
            ...
            <Button onClick={handleDrawerSubmit} className="bg-blue-500 text-white">
              Submit
            </Button>
          </div>
        </DrawerContent>
