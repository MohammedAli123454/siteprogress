...
import { files as filesSchema } from "../configs/schema"; // Use an alias to avoid naming conflict
import { put } from "@vercel/blob";  // Import only the put method from Vercel Blob
